...
public class ClosetGridAdapter3 extends BaseAdapter {

    private Context mContext3;
    private List<DocumentSnapshot> imageList = new ArrayList<>();

    public ClosetGridAdapter3(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView ==  null) {
            convertView = LayoutInflater.from(mContext3).inflate(R.layout.closet_grid_item, parent, false);
        }
        ImageView imageView;
