...
public class ClosetFragment extends Fragment implements ClosetFragmentListener {
    ...
    private void setupShowcaseImageView(View view) {
    ...
    private void setupImageGridView(View view) {
        ...
        if(gridImageList != null && !gridImageList.isEmpty()) {
    ...
    private void uploadImage(Uri uri) {
        if (uri != null) {
            try {
                ...
                mAuth=FirebaseAuth.getInstance();
                String currentUser=mAuth.getCurrentUser().getUid();
                final StorageReference filePath=mStorageRef.child("UserClosetImages").child(currentUser).child(UUID.randomUUID().toString());
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                final Map<String,Object> data_time=new HashMap<>();
                                ...
                                db.collection("users").document(currentUser)
                                    ...
                                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                                        ...
                                        //adding image and refreshing the gridView
                                        gridImageList.add(documentSnapshot);
                                        closetGridAdapter.addImage(documentSnapshot);
                                    }
                                });
                            }
                        });
    ...
    public void onImageListReceived() {
        setupShowcaseImageView(view);
        setupImageGridView(view);
    }
